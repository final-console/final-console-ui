  ...
  _defineProperty(this, "getSubMenuOrItem", function (item, level) {
    ...
    if (Array.isArray(children) && children.length > 0) {
      ...
      var defaultTitle = /*#__PURE__*/_jsxs("div", {
        className: classNames("".concat(baseClassName, "-item-title"), (_this$props3 = _this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.hashId, (_classNames = {}, _defineProperty(_classNames, "".concat(baseClassName, "-item-title-collapsed"), collapsed), _defineProperty(_classNames, "".concat(baseClassName, "-item-title-collapsed-level-").concat(level), collapsed), _defineProperty(_classNames, "".concat(baseClassName, "-group-item-title"), menuType === 'group'), _defineProperty(_classNames, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames)),
