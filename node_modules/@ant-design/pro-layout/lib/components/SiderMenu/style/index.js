...
var genSiderMenuStyle = function genSiderMenuStyle(token) {
  ...
  return (0, _defineProperty2.default)({}, "".concat(token.proComponentsCls, "-layout"), (_$concat2 = {}, (0, _defineProperty2.default)(_$concat2, "".concat(token.antCls, "-layout-sider").concat(token.componentCls), {
  ...
  }), (0, _defineProperty2.default)(_$concat2, token.componentCls, (_token$componentCls = {
    position: 'relative',
    ...
    color: (_token$layout4 = token.layout) === null || _token$layout4 === void 0 ? void 0 : (_token$layout4$sider = _token$layout4.sider) === null || _token$layout4$sider === void 0 ? void 0 : _token$layout4$sider.colorTextMenuItemHover
    ...
    height: '100%',
    '&-mix': {
      height: "calc(100% - ".concat(((_token$layout11 = token.layout) === null || _token$layout11 === void 0 ? void 0 : (_token$layout11$heade = _token$layout11.header) === null || _token$layout11$heade === void 0 ? void 0 : _token$layout11$heade.heightLayoutHeader) || 56, "px)"),
      insetBlockStart: "".concat(((_token$layout12 = token.layout) === null || _token$layout12 === void 0 ? void 0 : (_token$layout12$heade = _token$layout12.header) === null || _token$layout12$heade === void 0 ? void 0 : _token$layout12$heade.heightLayoutHeader) || 56, "px")
    }
  }), _$concat2));
};
