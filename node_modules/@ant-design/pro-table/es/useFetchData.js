...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var _useMountMergeState3 = useMountMergeState(false, {
      value: _typeof(options === null || options === void 0 ? void 0 : options.loading) === 'object' ? options === null || options === void 0 ? void 0 : (_options$loading = options.loading) === null || _options$loading === void 0 ? void 0 : _options$loading.spinning : options === null || options === void 0 ? void 0 : options.loading,
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return Promise.race([fetchList(isPolling), new Promise(function (_, reject) {
              var _abortRef$current, _abortRef$current$sig, _abortRef$current$sig2;
              (_abortRef$current = abortRef.current) === null || _abortRef$current === void 0 ? void 0 : (_abortRef$current$sig = _abortRef$current.signal) === null || _abortRef$current$sig === void 0 ? void 0 : (_abortRef$current$sig2 = _abortRef$current$sig.addEventListener) === null || _abortRef$current$sig2 === void 0 ? void 0 : _abortRef$current$sig2.call(_abortRef$current$sig, 'abort', function () {
                reject('aborted');
                // 结束强求，并且清空loading控制
