...
function getButtonText(_ref, options) {
  var _options$reloadIcon, _options$densityIcon;
  var intl = _ref.intl;
  return {
    reload: {
    ...
    density: {
      ...
      icon: (_options$densityIcon = options.densityIcon) !== null && _options$densityIcon !== void 0 ? _options$densityIcon : /*#__PURE__*/(0, _jsxRuntime.jsx)(_DensityIcon.default, {})
    },
    fullScreen: {
