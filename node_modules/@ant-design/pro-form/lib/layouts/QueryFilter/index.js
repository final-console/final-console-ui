...
var flatMapItems = function flatMapItems(items, ignoreRules, form) {
  return items === null || items === void 0 ? void 0 : items.flatMap(function (item) {
    ...
    if ((item === null || item === void 0 ? void 0 : item.type.displayName) === 'ProFormDependency' && !((_item$props2 = item.props) !== null && _item$props2 !== void 0 && _item$props2.title)) {
      var _values = item.props.name.reduce(function (current, next) {
        return (0, _objectSpread3.default)((0, _objectSpread3.default)({}, current), {}, (0, _defineProperty2.default)({}, next, form === null || form === void 0 ? void 0 : form.getFieldValue(next)));
      }, {});
      return item.props.children(_values);
    }
    if (ignoreRules && /*#__PURE__*/_react.default.isValidElement(item)) {
      var _item$props3;
      return /*#__PURE__*/_react.default.cloneElement(item, (0, _objectSpread3.default)((0, _objectSpread3.default)({}, item.props), {}, {
        formItemProps: (0, _objectSpread3.default)((0, _objectSpread3.default)({}, (_item$props3 = item.props) === null || _item$props3 === void 0 ? void 0 : _item$props3.formItemProps), {}, {
          rules: []
        })
      }));
    }
...
var QueryFilterContent = function QueryFilterContent(props) {
  ...
  var submitter = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/_react.default.cloneElement(props.submitter, (0, _objectSpread3.default)({
      searchConfig: {
        resetText: resetText,
        submitText: searchText
      },
      render: optionRender ? function (_, dom) {
        return optionRender((0, _objectSpread3.default)((0, _objectSpread3.default)({}, props), {}, {
          resetText: resetText,
  ...
  // 处理过，包含是否需要隐藏的 数组
  var processedList = flatMapItems(items, props.ignoreRules, form).map(function (item, index) {
    var _item$props$colSize, _item$props4, _props2, _item$props5;
    // 如果 formItem 自己配置了 hidden，默认使用它自己的
    var colSize = /*#__PURE__*/_react.default.isValidElement(item) ? (_item$props$colSize = item === null || item === void 0 ? void 0 : (_item$props4 = item.props) === null || _item$props4 === void 0 ? void 0 : _item$props4.colSize) !== null && _item$props$colSize !== void 0 ? _item$props$colSize : 1 : 1;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_antd.Row, {
    ...
    children: [doms, submitter && /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Col, (0, _objectSpread3.default)((0, _objectSpread3.default)({
      span: spanSize.span,
      offset: offset,
...
function QueryFilter(props) {
  ...
  return wrapSSR( /*#__PURE__*/(0, _jsxRuntime.jsx)(_rcResizeObserver.default, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_BaseForm.BaseForm, (0, _objectSpread3.default)((0, _objectSpread3.default)({
