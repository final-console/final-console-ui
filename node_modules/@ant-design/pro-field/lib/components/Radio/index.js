...
var FieldRadio = function FieldRadio(_ref, ref) {
  ...
  var status = (_Form$Item = _antd.Form.Item) === null || _Form$Item === void 0 ? void 0 : (_Form$Item$useStatus = _Form$Item.useStatus) === null || _Form$Item$useStatus === void 0 ? void 0 : _Form$Item$useStatus.call(_Form$Item);
  ...
  var _useStyle = (0, _proUtils.useStyle)('FieldRadioRadio', function (token) {
      var _ref2;
      return _ref2 = {}, (0, _defineProperty2.default)(_ref2, ".".concat(layoutClassName, "-error"), {
        span: {
          color: token.colorError
        }
      }), (0, _defineProperty2.default)(_ref2, ".".concat(layoutClassName, "-warning"), {
        span: {
          color: token.colorWarning
        }
      }), (0, _defineProperty2.default)(_ref2, ".".concat(layoutClassName, "-vertical"), (0, _defineProperty2.default)({}, "".concat(token.antCls, "-radio-wrapper"), {
        display: 'flex',
        marginInlineEnd: 0
      })), _ref2;
    }),
  ...
  if (mode === 'edit') {
    ...
    var _dom = wrapSSR( /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Radio.Group, (0, _objectSpread3.default)((0, _objectSpread3.default)({
      ...
      className: (0, _classnames.default)((_rest$fieldProps = rest.fieldProps) === null || _rest$fieldProps === void 0 ? void 0 : _rest$fieldProps.className, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(layoutClassName, "-error"), (status === null || status === void 0 ? void 0 : status.status) === 'error'), (0, _defineProperty2.default)(_classNames, "".concat(layoutClassName, "-warning"), (status === null || status === void 0 ? void 0 : status.status) === 'warning'), _classNames), hashId, "".concat(layoutClassName, "-").concat(rest.fieldProps.layout || 'horizontal')),
      options: options
    })));
    if (renderFormItem) {
      var _renderFormItem;
