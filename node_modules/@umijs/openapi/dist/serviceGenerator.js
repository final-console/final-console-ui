...
class ServiceGenerator {
                ...
                try {
                    ...
                    return Object.assign(Object.assign({}, newApi), { functionName, typeName: this.getTypeName(newApi), path: getPrefixPath(), pathInComment: formattedPath.replace(/\*/g, '&#42;'), hasPathVariables: formattedPath.includes('{'), hasApiPrefix: !!this.config.apiPrefix, method: newApi.method, 
                        ...
                        desc: functionName === newApi.summary
                            ...
                            ].filter((s) => s).join(' '), hasHeader: !!(params && params.header) || !!(body && body.mediaType), params: finalParams, hasParams: Boolean(Object.keys(finalParams || {}).length), body,
    ...
    getResponseTP(responses = {}) {
        ...
        if (schema.$ref) {
            ...
            if ((childrenSchema === null || childrenSchema === void 0 ? void 0 : childrenSchema.type) === 'object' && 'properties' in childrenSchema && this.config.dataFields) {
                schema = ((_a = this.config.dataFields.map(field => childrenSchema.properties[field]).filter(Boolean)) === null || _a === void 0 ? void 0 : _a[0]) || resContent[mediaType].schema || DEFAULT_SCHEMA;
            }
        }
